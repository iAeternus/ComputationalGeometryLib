...
class Vector2Test {
    ...
    public void unit() {
        ...
        assertThat(unit).isEqualTo(new Vector2(1, 0));
    }

    @Test
    public void alpha() {
        // Given
        Vector2 v = new Vector2(1, Math.sqrt(3));

        // When
        double alpha = v.alpha();

        // Then
        System.out.println(alpha);
        assertThat(alpha).isEqualTo(MathConstants.PI / 3);
    }
